...
class OrderController {
    ...
    public async list (req:Request,res:Response){
        ...
        'select i.id as id,p.nombre as productName,i.descripcion as description,i.cantidad as count,i.montoTotal as totalAmount,i.tmstmp as tmstmp from item i join producto p on i.productoId = p.id'));
    }
